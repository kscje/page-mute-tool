...
I18n.prototype.fallbackMessages = {
  zh_CN: {
    extensionName: { message: '网站自动播放拦截器' },
    extensionDescription: { message: '阻止指定域名网页中的媒体自动播放，强制用户手动点击播放' },
    popupTitle: { message: '网站自动播放拦截器' },
    ...
    optionsTitle: { message: '网站自动播放拦截器 - 设置' },
    ...
    license: { message: '许可证：' },
    support: { message: '支持：' },
    feedbackTitle: { message: '提交建议说明：' },
    feedbackDescription: { message: '如有任何建议反馈，可联系作者：' },
  ...
  en: {
    ...
    optionsTitle: { message: 'Autoplay Blocker - Settings' },
    ...
    feedbackDescription: { message: 'If you have any suggestions or feedback, contact the author: ' },
